    ...
    return (
      <div className="flex items-center justify-center w-full h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
        <div className="bg-white p-8 rounded-2xl shadow-lg max-w-md w-full mx-4">
          ...
          <p className="text-gray-600 mb-6">정보를 입력해주세요.</p>
          <form onSubmit={handleStudentSubmit} className="space-y-4">
            ...
            <div className="pt-4 space-y-2">
              ...
              <button
                ...
                className="w-full px-4 py-2 bg-gray-300 text-gray-800 font-bold rounded-lg hover:bg-gray-400 transition"
              >
                뒤로가기
              </button>
            </div>
